...
int main()
{
	...
	while(1) {
		...
		cout << "  4. Tambah Data Mata Kuliah" << endl;
		cout << "  5. Tampilkan semua Data Mahasiswa" << endl;
		cout << "  6. Tampilkan semua Data Dosen" << endl;
		cout << "  7. Tampilkan semua Data Tenaga Kependidikan" << endl;
		cout << "  8. Tampilkan semua Data Mata Kuliah" << endl;
		...
		switch (menu_terpilih) {
			...
			case 4:{
				...
				cin >> judul;
				cout << "Masukkan Total SKS Mata Kuliah : "<< endl;
				cin >> sksmatkul;

				matakuliah datamatkul(kode,judul,sksmatkul);
				recMatkul.push_back(datamatkul);
			...
			case 7:{
				...
				break;
			case 8:{
				cout << "Data seluruh Mata Kuliah : " << endl;
				for(int i=0; i < d; i++)
				{
				cout << "Kode Mata Kuliah: " << recMatkul[i].getkode() <<endl;
				cout << "Nama Mata Kuliah: " << recMatkul[i].getjudul() <<endl;
